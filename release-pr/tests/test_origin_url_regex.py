...
def test_round_trip_parse_then_generate():
    test_cases = [
        ...
        ("git@github-neon.com:neondatabase/dev-actions.git", "neondatabase/dev-actions"),
        ("git@github.com-emu:databricks-eng/hadron.git", "databricks-eng/hadron"),
        ("git@github-neon.com:neondatabase/dev-actions.git", "neondatabase/dev-actions"),
        ("git@github.com-emu:databricks-eng/hadron.git", "databricks-eng/hadron"),
    ]
    for url, expected_repo in test_cases:
        assert git.github_repo(url) == expected_repo, f"Expected {expected_repo} for url {url}"
